...
class AttnPooling(nn.Module):
    def __init__(self, num_classes=1, attention=True, normalize_attn=True, init='xavierUniform'):
        ...
        self.dense = nn.Conv1d(in_channels=64, out_channels=64, kernel_size=75, padding=0, bias=True)
        self.attn= LinearAttentionBlock(in_features=64, normalize_attn=normalize_attn)
